...
ALL_EXERCISES = $(BUILD_DIR)/exercise00.pdf $(BUILD_DIR)/exercise01.pdf $(BUILD_DIR)/exercise02.pdf $(BUILD_DIR)/exercise03.pdf $(BUILD_DIR)/exercise04.pdf $(BUILD_DIR)/exercise05.pdf $(BUILD_DIR)/exercise06.pdf $(BUILD_DIR)/exercise07.pdf $(BUILD_DIR)/exercise08.pdf $(BUILD_DIR)/exercise09.pdf
...
$(BUILD_DIR)/svg/cc-by-sa-4-0.pdf: common/cc-by-sa-4.0.svg
